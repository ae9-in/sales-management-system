    ...
    <div className="flex flex-col min-h-screen text-gray-100 transition-all duration-200 bg-gray-900 animate-fadeIn overflow-hidden">
      <main className="flex-1 w-full max-w-screen-2xl p-4 md:p-6 mx-auto overflow-auto">
        ...
        <div className="mb-6 flex justify-between items-end">
          <div>
            <h1 className="text-3xl font-bold text-white mb-1">Daily Sales</h1>
            <p className="text-gray-400 text-sm">Track and manage all the sales made on a daily basis.</p>
          </div>
          <div className="flex gap-3">
            <div className="relative flex items-center bg-gray-800 border border-gray-700 rounded-lg hover:bg-gray-700/85 transition px-3 py-2">
          ...
          <div className="bg-gray-800 border border-gray-700 rounded-xl p-6 w-full max-w-md shadow-2xl relative">
            ...
            <div className="space-y-4 text-xs text-gray-300">
              ...
              <div className="grid grid-cols-2 border-b border-gray-700/50 pb-2">
                ...
                <span className="text-gray-200 font-semibold">{viewingSale.status}</span>
              </div>
              <div className="grid grid-cols-2 border-b border-gray-700/50 pb-2">
