...
import { Users, DollarSign, Award, IndianRupee } from 'lucide-react';
...
const ExecutivesStats = ({ employees = [], sales = [] }) => {
  ...
  return (
    <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4 mb-6">
      ...
      <StatCard title="Team Revenue" value={`₹${totalRev.toLocaleString()}`} change="15.8%" isPositive={true} icon={IndianRupee} colorClass="bg-yellow-500/10 text-yellow-400" />
