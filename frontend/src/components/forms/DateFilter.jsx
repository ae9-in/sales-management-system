  ...
  return (
    <div className="relative" ref={popupRef}>
      <div className="flex items-center gap-3">
        ...
        <button
          className="flex items-center gap-2 px-4 py-2.5 glass-card text-gray-700 hover:border-emerald-300 hover-lift transition-all"
      ...
      {dateFilter.pickerOpen && (
        <div className="absolute top-full right-0 z-50 mt-2 w-[300px] flex flex-col gap-4 rounded-lg border border-gray-200 bg-white p-4 shadow-xl">
          ...
          <button
            className="px-4 py-2 mt-2 text-white font-semibold rounded-lg bg-emerald-600 hover:bg-emerald-700 transition-all hover-lift"
