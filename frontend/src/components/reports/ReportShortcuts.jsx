...
const shortcuts = [
  { icon: BarChart2, title: 'Sales Report', subtext: 'Overview of all sales', color: 'text-emerald-600 bg-emerald-500/10' },
...
const ReportShortcuts = () => (
  <div className="glass-card-elevated p-5 mb-6">
    ...
    <div className="space-y-2">
      {shortcuts.map((s, i) => (
        <div key={i} className="flex items-center justify-between p-3 rounded-lg hover:bg-gray-100/50 cursor-pointer border border-transparent hover:border-gray-200 transition">
    ...
    <button className="w-full mt-4 py-2 border border-blue-600/50 text-emerald-600 text-sm font-semibold rounded-lg hover:bg-emerald-600/10 transition">View All Reports</button>
  </div>
);
