...
export const SkeletonStatsCard = () => (
  <div className="p-4 rounded-xl border border-gray-200/50 bg-white/30 flex items-center gap-4">
...
export const SkeletonPageFallback = () => (
  <div className="flex flex-col min-h-screen bg-gradient-to-br from-gray-50 via-white to-emerald-50/20 p-6 animate-fadeIn">
