...
import { Package, Award, IndianRupee, ShieldAlert } from 'lucide-react';
...
const ProductsStats = ({ inventory = [] }) => {
  ...
  return (
    <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4 mb-6">
      ...
      <StatCard title="Catalog Value" value={catalogValueDisplay} icon={IndianRupee} color="bg-yellow-500/10 text-yellow-400" />
    </div>
  );
};
