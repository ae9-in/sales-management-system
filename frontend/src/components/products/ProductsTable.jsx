            ...
            {filtered.map((row, index) => {
              ...
              return (
                ...
                >
                  ...
                  <td className="px-4 py-3 font-medium text-gray-300 whitespace-nowrap">{row.name}</td>
                  <td className="px-4 py-3 text-gray-400">PRD-{String(row.id).padStart(4, '0')}</td>
                  <td className="px-4 py-3 font-medium text-gray-300">₹{(row.price || 0).toLocaleString()}</td>
