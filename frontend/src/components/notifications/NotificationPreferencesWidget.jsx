...
const NotificationPreferencesWidget = () => {
  ...
  return (
    <div className="p-4 bg-gray-800 border border-gray-700 rounded-xl">
      <h3 className="font-semibold text-gray-100 mb-4 text-sm">Notification Preferences</h3>
      <div className="space-y-4 mb-4">
        
        <div 
          onClick={toggleEmail} 
          className="flex justify-between items-center text-xs cursor-pointer hover:bg-gray-700/20 p-1 rounded transition"
        >
        ...
        >
          <div className="flex items-center gap-3">
            ...
            <span className="text-gray-300 font-medium">Browser Notifications</span>
          </div>
      ...
      <button 
        ...
        className="w-full flex items-center justify-between border border-gray-700 bg-transparent text-gray-300 hover:text-white px-3 py-2 rounded-lg text-xs hover:bg-gray-700/50 transition"
      >
