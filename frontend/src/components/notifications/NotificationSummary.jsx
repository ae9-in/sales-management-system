...
const NotificationSummary = ({ notifications = [] }) => {
  ...
  return (
    <div className="p-4 bg-gray-800 border border-gray-700 rounded-xl mb-6">
      <h3 className="font-semibold text-gray-100 mb-4 text-sm">Notification Summary</h3>
      
      <div className="flex items-center gap-6 mb-2">
        <div className="relative shrink-0 w-16 h-16 bg-blue-600/10 rounded-full flex items-center justify-center text-blue-400 border border-blue-500/20">
          <Bell size={32} />
          {unreadCount > 0 && (
